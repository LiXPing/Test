        ...
        <div class="rs_content">
        	<form method="post" action="handle_add.do">
	            ...
	            <div data-toggle="distpicker" class="address_content">
					 ...
					 <select name="recvProvince" data-province="---- 选择省 ----" id="receiverState">
					 	<option>---- 选择省 ----</option>
					 	<c:forEach var="province" items="${provinces }">
					 	<option value="${province.proviceCode }">${province.proviceName }</option>
					 	</c:forEach>
					 </select>
					  城市：
					 <select name="recvCity" data-city="---- 选择市 ----" id="receiverCity"></select>
					  区/县：
					 <select name="recvArea" data-district="---- 选择区 ----" id="receiverDistrict"></select>
				</div> 
